...
namespace Restaurante.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Codigo,Nombre,Descripcion,Precio,Tipo,IdSucursal")] Producto producto)
        {
            ...
            ViewData["IdSucursal"] = new SelectList(_context.Sucursals, "Id", "Id", producto.IdSucursal);
            return View(producto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,Nombre,Descripcion,Precio,Tipo,IdSucursal")] Producto producto)
        {
